...
class EntityTestState: public our::State {
    ...
    void onDraw(double deltaTime) override {
        ...
        glm::mat4 ViewProjection = camera->getProjectionMatrix(size) * camera->getViewMatrix();
        ...
        for(auto& entity : world.getEntities()){
            ...
            meshRenderer->material->shader->set("transform", ViewProjection * meshRenderer->getOwner()->getLocalToWorldMatrix());
