...
class EntityTestState: public our::State {
    ...
    void onDraw(double deltaTime) override {
        ...
        //TODO: (Req 8) Change the following line to compute the correct view projection matrix from the camera
        glm::mat4 VP = camera->getProjectionMatrix(size) * camera->getOwner()->getLocalToWorldMatrix();
