...
our::Texture2D* our::texture_utils::empty(GLenum format, glm::ivec2 size){
    ...
    // HINT: Use glTexImage2D to create an empty texture
    // HINT: Use glTexParameteri to set the texture parameters
    // HINT: Use glGenerateMipmap to generate mipmaps for the texture
