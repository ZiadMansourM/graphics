...
namespace our {
    ...
    public:
        ...
        Texture2D() {
            ...
            // HINT: Use glGenTextures to create a texture and save its name in the member variable "name"
        ...
        ~Texture2D() { 
            //TODO: (Req 5) Complete this function
            // HINT: Use glDeleteTextures to delete the texture
        ...
        void bind() const {
            //TODO: (Req 5) Complete this function
            // HINT: Use glBindTexture to bind this texture to GL_TEXTURE_2D
        ...
        static void unbind(){
            //TODO: (Req 5) Complete this function
            // HINT: Use glBindTexture to bind 0 to GL_TEXTURE_2D
